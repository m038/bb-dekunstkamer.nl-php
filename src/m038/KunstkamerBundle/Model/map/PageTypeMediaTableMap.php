...
/**
 * This class defines the structure of the 'tblPageTypeMedia' table.
 *
 *
 *
 ...
 */
class PageTypeMediaTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.m038.KunstkamerBundle.Model.map.PageTypeMediaTableMap';
    ...
    {
        // attributes
        $this->setName('tblPageTypeMedia');
        $this->setPhpName('PageTypeMedia');
        $this->setClassname('m038\\KunstkamerBundle\\Model\\PageTypeMedia');
