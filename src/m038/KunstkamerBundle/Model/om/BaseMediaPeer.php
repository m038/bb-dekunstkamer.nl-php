...
use m038\KunstkamerBundle\Model\map\MediaTableMap;

/**
 * Base static class for performing query and update operations on the 'tblMedia' table.
 *
 * 
 *
...
abstract class BaseMediaPeer {
    ...
    const TABLE_NAME = 'tblMedia';

    /** the related Propel class for this table */
    const OM_CLASS = 'm038\\KunstkamerBundle\\Model\\Media';
    ...
    const INTID = 'tblMedia.INTID';

    /** the column name for the STRPATH field */
    const STRPATH = 'tblMedia.STRPATH';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (self::INTID, self::STRPATH, ),
        BasePeer::TYPE_RAW_COLNAME => array ('INTID', 'STRPATH', ),
        BasePeer::TYPE_FIELDNAME => array ('intID', 'strPath', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (self::INTID => 0, self::STRPATH => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('INTID' => 0, 'STRPATH' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('intID' => 0, 'strPath' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MediaPeer::INTID);
            $criteria->addSelectColumn(MediaPeer::STRPATH);
        } else {
            $criteria->addSelectColumn($alias . '.INTID');
            $criteria->addSelectColumn($alias . '.STRPATH');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to tblMedia
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(MediaPeer::INTID) && $criteria->keyContainsValue(MediaPeer::INTID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(MediaPeer::INTID);
            $value = $criteria->remove(MediaPeer::INTID);
            if ($value) {
                $selectCriteria->add(MediaPeer::INTID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the tblMedia table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int The number of affected rows (if supported by underlying database driver).
     */
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MediaPeer::INTID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria->add(MediaPeer::INTID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(MediaPeer::DATABASE_NAME);
            $criteria->add(MediaPeer::INTID, $pks, Criteria::IN);
