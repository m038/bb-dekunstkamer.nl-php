...
/**
 * Base class that represents a row from the 'tblPageTypes' table.
 *
 * 
 *
 * @package    propel.generator.src.m038.KunstkamerBundle.Model.om
 */
abstract class BasePageType extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'm038\\KunstkamerBundle\\Model\\PageTypePeer';
    ...
    /**
     * The value for the intenabled field.
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $intenabled;

    /**
     * The value for the strdatatable field.
     * @var        string
     */
    protected $strdatatable;
    ...
    /**
     * Initializes internal state of BasePageType object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [intenabled] column value.
     * 
     * @return   boolean
     */
    ...
    /**
     * Get the [strdatatable] column value.
     * 
     * @return   string
     */
     ...
     * @return   PageType The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->intid !== $v) {
            $this->intid = $v;
            $this->modifiedColumns[] = PageTypePeer::INTID;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->strname !== $v) {
            $this->strname = $v;
            $this->modifiedColumns[] = PageTypePeer::STRNAME;
        }
    ...
    /**
     * Sets the value of the [intenabled] column.
    ...
    public function setenabled($v)
    {
        ...
        if ($this->intenabled !== $v) {
            $this->intenabled = $v;
            $this->modifiedColumns[] = PageTypePeer::INTENABLED;
        }
    ...
    /**
     * Set the value of [strdatatable] column.
     * 
     * @param      string $v new value
     * @return   PageType The current object (for fluent API support)
     */
    public function setdatatable($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->strdatatable !== $v) {
            $this->strdatatable = $v;
            $this->modifiedColumns[] = PageTypePeer::STRDATATABLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->intenabled = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
            $this->strdatatable = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = PageTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PageType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PageTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PageTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PageTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PageTypePeer::INTID)) {
            $modifiedColumns[':p' . $index++]  = '`INTID`';
        }
        if ($this->isColumnModified(PageTypePeer::STRNAME)) {
            $modifiedColumns[':p' . $index++]  = '`STRNAME`';
        }
        if ($this->isColumnModified(PageTypePeer::INTENABLED)) {
            $modifiedColumns[':p' . $index++]  = '`INTENABLED`';
        }
        if ($this->isColumnModified(PageTypePeer::STRDATATABLE)) {
            $modifiedColumns[':p' . $index++]  = '`STRDATATABLE`';
        }

        $sql = sprintf(
            'INSERT INTO `tblPageTypes` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`STRNAME`':
                        ...
                        break;
                    case '`INTENABLED`':
						$stmt->bindValue($identifier, (int) $this->intenabled, PDO::PARAM_INT);
                        break;
                    case '`STRDATATABLE`':
						$stmt->bindValue($identifier, $this->strdatatable, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PageTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PageTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PageType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PageType'][$this->getPrimaryKey()] = true;
        $keys = PageTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
            $keys[2] => $this->getenabled(),
            $keys[3] => $this->getdatatable(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setdatatable($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PageTypePeer::INTID)) $criteria->add(PageTypePeer::INTID, $this->intid);
        if ($this->isColumnModified(PageTypePeer::STRNAME)) $criteria->add(PageTypePeer::STRNAME, $this->strname);
        if ($this->isColumnModified(PageTypePeer::INTENABLED)) $criteria->add(PageTypePeer::INTENABLED, $this->intenabled);
        if ($this->isColumnModified(PageTypePeer::STRDATATABLE)) $criteria->add(PageTypePeer::STRDATATABLE, $this->strdatatable);
    ...
    {
        $criteria = new Criteria(PageTypePeer::DATABASE_NAME);
        $criteria->add(PageTypePeer::INTID, $this->intid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of PageType (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setdatatable($this->getdatatable());
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 PageType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this PageType is new, it will return
     ...
     * Otherwise if this PageType is new, it will return
     * an empty collection; or if this PageType has previously
     * been saved, it will retrieve related Pages from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PageType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      PropelPDO $con optional connection object
     ...
     * @return PropelCollection|array Page[] List of Page objects
     */
    public function getPagesJoinLanguage($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PageQuery::create(null, $criteria);
    ...
    public function clear()
    {
        $this->intid = null;
        $this->strname = null;
        $this->intenabled = null;
        $this->strdatatable = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(PageTypePeer::DEFAULT_STRING_FORMAT);
    }
