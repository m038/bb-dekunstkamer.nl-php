...
use m038\KunstkamerBundle\Model\map\LanguageTableMap;

/**
 * Base static class for performing query and update operations on the 'tblLanguages' table.
 *
 * 
 *
...
abstract class BaseLanguagePeer {
    ...
    const TABLE_NAME = 'tblLanguages';

    /** the related Propel class for this table */
    const OM_CLASS = 'm038\\KunstkamerBundle\\Model\\Language';
    ...
    const INTID = 'tblLanguages.INTID';

    /** the column name for the STRNAME field */
    const STRNAME = 'tblLanguages.STRNAME';

    /** the column name for the STRABBREVIATION field */
    const STRABBREVIATION = 'tblLanguages.STRABBREVIATION';

    /** the column name for the STRLOCALE field */
    const STRLOCALE = 'tblLanguages.STRLOCALE';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('id', 'name', 'abbreviation', 'locale', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'abbreviation', 'locale', ),
        BasePeer::TYPE_COLNAME => array (self::INTID, self::STRNAME, self::STRABBREVIATION, self::STRLOCALE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('INTID', 'STRNAME', 'STRABBREVIATION', 'STRLOCALE', ),
        BasePeer::TYPE_FIELDNAME => array ('intID', 'strName', 'strAbbreviation', 'strLocale', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('id' => 0, 'name' => 1, 'abbreviation' => 2, 'locale' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'abbreviation' => 2, 'locale' => 3, ),
        BasePeer::TYPE_COLNAME => array (self::INTID => 0, self::STRNAME => 1, self::STRABBREVIATION => 2, self::STRLOCALE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('INTID' => 0, 'STRNAME' => 1, 'STRABBREVIATION' => 2, 'STRLOCALE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('intID' => 0, 'strName' => 1, 'strAbbreviation' => 2, 'strLocale' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(LanguagePeer::INTID);
            $criteria->addSelectColumn(LanguagePeer::STRNAME);
            $criteria->addSelectColumn(LanguagePeer::STRABBREVIATION);
            $criteria->addSelectColumn(LanguagePeer::STRLOCALE);
        } else {
            $criteria->addSelectColumn($alias . '.INTID');
            $criteria->addSelectColumn($alias . '.STRNAME');
            $criteria->addSelectColumn($alias . '.STRABBREVIATION');
            $criteria->addSelectColumn($alias . '.STRLOCALE');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to tblLanguages
     * by a foreign key with ON DELETE CASCADE
     */
    public static function clearRelatedInstancePool()
    {
        // Invalidate objects in MediaLangPeer instance pool,
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(LanguagePeer::INTID) && $criteria->keyContainsValue(LanguagePeer::INTID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(LanguagePeer::INTID);
            $value = $criteria->remove(LanguagePeer::INTID);
            if ($value) {
                $selectCriteria->add(LanguagePeer::INTID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the tblLanguages table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int The number of affected rows (if supported by underlying database driver).
     */
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(LanguagePeer::INTID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria->add(LanguagePeer::INTID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(LanguagePeer::DATABASE_NAME);
            $criteria->add(LanguagePeer::INTID, $pks, Criteria::IN);
